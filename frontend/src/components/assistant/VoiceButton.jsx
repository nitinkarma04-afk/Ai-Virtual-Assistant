  ...
  if (!isSupported) {
    return (
      <button
        ...
        className={cn(
          'p-2.5 rounded-xl bg-slate-900/40 text-slate-600 border border-slate-800 cursor-not-allowed transition-all opacity-60',
          className
        )}
  ...
  return (
    <div className="relative inline-flex items-center">
      <button
        ...
        className={cn(
          'p-2.5 rounded-xl border transition-all duration-200 cursor-pointer select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400',
          isListening
            ? 'bg-emerald-500/20 text-emerald-300 border-emerald-400/80 shadow-lg shadow-emerald-500/30 animate-pulse'
            : error
            ? 'bg-rose-500/10 text-rose-400 border-rose-500/40 hover:bg-rose-500/20'
            : 'bg-slate-900/70 text-slate-300 border-slate-800 hover:text-cyan-300 hover:border-cyan-500/40 hover:bg-slate-800/80',
