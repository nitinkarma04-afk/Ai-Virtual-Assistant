      ...
      >
        ...
        <div className="flex items-start justify-between">
          ...
          <button
            onClick={onClose}
            disabled={isDeleting}
            className="p-1 text-slate-500 hover:text-slate-300 transition-colors focus:outline-none"
        ...
        <div className="space-y-2">
          <h3 id="delete-dialog-title" className="text-xl font-bold text-white tracking-tight">
            Clear Conversation History?
          </h3>
          <p className="text-sm text-slate-400 leading-relaxed">
            This action will permanently delete <strong className="text-slate-200">all past conversation logs</strong> from your account. This process cannot be undone.
          </p>
        </div>
